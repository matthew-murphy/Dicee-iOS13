...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified diceImageViewOne;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified diceImageViewTwo;
- (IBAction)rollButton:(UIButton * _Nonnull)sender;
